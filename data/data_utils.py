...
def filter_dcm2attribs(filters, dcm2attribs):
    """filters input dcm2attribs dict based on dict of filters (Note: Modifies input dcm2attribs)

    Arguments:
        filters {dict} -- dict of filters i.e. filters = {'seq':'AX SSFSE ABD/PEL'}
        dcm2attribs {dict} -- dict of dcms: attributes generated by function make_dcmdicts()
    ...
    for dcm in remove: del dcm2attribs[dcm]
